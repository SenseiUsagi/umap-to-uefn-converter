				...
				{error.status !== 404 && (
					<Row>
						<Column size={6}>
							...
							>
								<Header size="medium">
									Please do a screenshot of this page an create an issue on{" "}
									<a
									...
									<br />
									Please also provide details on how you got the error
								</Header>
							</Segment>
						</Column>
					</Row>
				...
				<Row>
					<Column size={6}>
						<Segment raised inverted={globalState.currentSettings.darkMode}>
							<Header size="medium">{error.statusText || error.message}</Header>
						</Segment>
					</Column>
				</Row>
			</Container>
